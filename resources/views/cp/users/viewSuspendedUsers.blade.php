    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Suspended users</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Suspended users table</h3>
                            </div>
                            <!-- /.card-header -->
                                            ...
                                            @foreach ($users as $user)
                                                    <tr id="user_{{$user['id']}}">
                                                        ...
                                                        <td class="actionsIcons">
                                                            ...
                                                            <a title="Unsuspend" href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" data-userid="{{$user['id']}}">
                                                                <i style="color: red;" class="fas fa-unlock fa-2x"></i>
                                                            </a>
                                                            @endif
                                                        </td>
                                                    </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="POST" >
                                            ...
                                            <button id="confirm_deletion" type="button" class="btn btn-danger" onclick="delete_user()">Unsuspend</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
        ...
        @if (hasAbility('suspend_users'))
            <script>
                ...
                function delete_user(){
                    $.ajax({
                        url:"/admincp/users/suspended/" + $("#user_id").val(),
                        type: 'post',
                        data: {
                            '_token':'{{csrf_token()}}',
                            },
